...
<!-- Fetch from Database -->
<?php $manage_movies = manage_movies(); ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                            ...
                                            <div class="btn-group mr-2">
                                                ...
                                                <div class="dropdown-menu" style="">
                                                    ...
                                                    <a class="dropdown-item btn-info">
                                                        <i class="fas fa-eye-slash"></i>&nbsp Movie Info
                                                    </a>
                                                    <a class="dropdown-item btn-details">
                                                        <i class="fas fa-eye-slash"></i>&nbsp Movie Details
                                                    </a>
                                                    <a class="dropdown-item btn-images">
                                                        <i class="fas fa-eye-slash"></i>&nbsp Movie Images
                                                    </a>
                                                    <a class="dropdown-item btn-manage">
                                                        <i class="fas fa-eye-slash"></i>&nbsp Manage Movies
                                                    </a>
                                ...
                                <table id="datatable" class="table table-striped table-hover table-bordered display nowrap"
                                    ...
                                    <tbody>
                                        <?php foreach ($manage_movies as $key => $manage_movie): ?>
                                        <tr>
                                            <td class="text-center align-middle">
                                                <input type="checkbox" class="checkbox select_img" name="ids[]" value="<?php echo $manage_movie['id'];?>"/>
                                                <input type="checkbox" class="checkbox" name="imgs[]" value="<?php echo $manage_movie['title'];?>" style="display: none;"/>
                                            </td>
                                            <td class="text-center align-middle"><?php echo $key + 1; ?></td>
                                            <td class="text-center align-middle"><?php echo $manage_movie['title']; ?></td>

                                            <?php $img_path = "../assets/images/movies/" ?>                                            
                                            <td class="text-center align-middle">
                                                <img class="rounded" src="<?php echo $img_path.'/'.$manage_movie['title'].'/'.$manage_movie['image']; ?>"
                                            ...
                                            <td class="text-center align-middle">
                                                <span class="group">
                                                <?php
                                                    $images = explode(",", $manage_movie['gallery_image']);
                                                    $counter = 0;    
                                                    foreach($images as $value):
                                                        if($counter < 3): 
                                                ?>
                                                        <img class="rounded" src="<?php echo $img_path.'/'.$manage_movie['title'].'/'.$value; ?>" 
                                                        style="width: 50px; height: 50px;">
                                                <?php
                                                    endif;
                                                    $counter++;
                                            ...
                                            <td class="text-center align-middle"><?php echo $manage_movie['genre']; ?></td>
                                            <td class="text-center align-middle"><?php echo $manage_movie['language']; ?></td>
                                            <td class="text-center align-middle"><?php echo $manage_movie['quality']; ?></td>
                                            <td class="text-center align-middle"><?php echo $manage_movie['rating']; ?></td>
                                            <td class="text-center align-middle"><?php echo $manage_movie['year']; ?></td>
                                            <td class="text-center align-middle"><?php echo $manage_movie['synopsis']; ?></td>
                                            <td class="text-center align-middle"><?php echo $manage_movie['slug']; ?></td>                                       
                                            <td class="text-center align-middle"><?php echo $manage_movie['uploaded_by']; ?></td>
                                            <td class="text-center align-middle"><?php echo $manage_movie['uploaded_on']; ?></td>
                                    ...
                                    <form method="post">
                                        <td class="text-center align-middle">
                                            <input type="hidden" name="status" value="<?php echo $manage_movie['id']; ?>">
                                        ...
                                        <td class="text-center align-middle">
                                            ...
                                            <a href="../movies/<?php echo $manage_movie['slug'] ?>" class="mr-3" style="color: dodgerblue;">
                                            ...
                                            <input type="hidden" name="delete-movie" value="<?php echo $manage_movie['id']; ?>">
                                            <input type="hidden" name="delete-image" value="<?php echo $manage_movie['title']; ?>">
                                            
                                            <button type="submit" name="single-m-delete" class="btn">
