    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row pt-4">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Edit TV-Show</h4>
                            <!-- Breadcrumb -->
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                    <li class="breadcrumb-item active">Edit TV-Show</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <form class="form-horizontal" method="post" action="edit-tvshow.php" enctype="multipart/form-data">
                            ...
                            <div class="card">
                                    ...
                                    <div class="p-2 border-bottom">                              
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body overflow-hidden">
                                                <h5 class="font-size-16 mb-1">TV-Show Header</h5>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-2 text-center">
                                        <img id="preview-image" class="img-prev rounded" src="../assets/images/tvshows/<?php echo $set_title; ?>/<?php echo $set_image; ?>" onerror="this.onerror=null;this.src='../assets/images/tvshows/not_found.png';" alt="Not Found"/>
                                    </div>
                                    <div class="col-md-10">
                            
                                        <div class="form-group mt-3 mb-4">
                                            <label class=" form-control-label">TV-Show Name</label>
                                            <input type="text" name="title" placeholder="Enter the TV-Show Name" class="form-control" value="<?php echo $set_title; ?>" required>
                                ...
                                <div class="card-body card-block">
                                    ...
                                    <div class="p-2 border-bottom mb-3">                              
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body overflow-hidden">
                                                <h5 class="font-size-16 mb-1">TV-Show Info</h5>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div id="gallery_prev">
                                                    ...
                                                    <?php foreach ($images as $img): ?>
                                                        <img class="col-3 rounded pb-3" src="../assets/images/tvshows/<?php echo $set_title; ?>/<?php echo $img?>">
                                                    <?php endforeach; ?>
                                                </div>
