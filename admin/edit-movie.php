    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row pt-4">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Edit Movie</h4>
                            <!-- Breadcrumb -->
                ...
                <div class="row">
                    <div class="col-12">
                        <form class="form-horizontal" method="post" action="edit-movie.php" enctype="multipart/form-data">
                            ...
                            <div class="card">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-2 text-center">
                                        <img id="preview-image" class="img-prev rounded" src="../assets/images/movies/<?php echo $set_title; ?>/<?php echo $set_image; ?>" onerror="this.onerror=null;this.src='../assets/images/movies/not_found.png';" alt="Not Found"/>
                                    </div>
                                    <div class="col-md-10">
                                            ...
                                            <div class="row">
                                                <div id="gallery_prev">
                                                    ...
                                                    <?php foreach ($images as $img): ?>
                                                        <img class="col-3 rounded pb-3" src="../assets/images/movies/<?php echo $set_title; ?>/<?php echo $img?>">
                                                    <?php endforeach; ?>
                                                </div>
