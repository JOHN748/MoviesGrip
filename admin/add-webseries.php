    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row pt-4">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Add Webseries</h4>
                            <!-- Breadcrumb -->
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                    <li class="breadcrumb-item active">Add Webseries</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <form class="form-horizontal" method="post" action="add-webseries.php" enctype="multipart/form-data">
                            ...
                            <div class="card">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-2 text-center">
                                        <img id="preview-image" class="img-prev rounded" src="#" alt="Upload" onerror=this.src="../assets/images/webseries/not_found.png" />
                                    </div>
                                    <div class="col-md-10">
                            
                                        <div class="form-group mt-3 mb-4">
                                            <label class=" form-control-label">Series Name</label>
                                            <input type="text" name="title" placeholder="Enter the Series Name" class="form-control" value="" required>
                                ...
                                <div class="card-body card-block">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mt-3 mb-3">
                                            ...
                                            <textarea name="synopsis" class="form-control" placeholder="Write the Series Synopsis..." rows="7" required><?php echo $synopsis ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12"> 
                                                ...
                                                <div class="form-group mt-3 mb-4">
                                                    <label class=" form-control-label">Webseries Slug</label>
                                                    <input type="text" name="slug" placeholder="Enter the Weberies slug" class="form-control" value="" required>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6">
                                    <div class="float-right">
                                        ...
                                        <button type="submit" name="add_series" class="btn btn-primary">
                                            Add Series
                                        </button>
                                    </div>
                                </div>
