...
<div id="content" class="row row--grid mt-4">
  ...
  <div class="result col-6 col-sm-4 col-lg-3 col-xl-2 <?php echo $movie_detail['quality']." ".$movie_detail['genre']." ".$movie_detail['language']." ".$movie_detail['rating']; ?>">
    <div class="movie-card mt10">
      <a href="#" class="card-cover">
        <img src="assets/images/movies/<?php echo $movie_detail['title']; ?>/<?php echo $movie_detail['image']; ?>" >
      ...
      <h3 class="card-title"><a href="#"><?php echo $movie_detail['title']; ?></a></h3>
    </div>
  </div>
