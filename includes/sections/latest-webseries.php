<div class="latest-webseries mt4">

<div class="section-title clearfix pt20">
	<div class="title-left">
		<h4>Latest Webseries</h4>
	</div>
	...
	<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
		<div class="movie-card mt10">
			<a href="webseries/<?php echo $series_detail['slug']; ?>" class="card-cover">
				<img src="assets/images/webseries/<?php echo $series_detail['title']; ?>/<?php echo $series_detail['image'] ?>" alt="Not Found" onerror="this.onerror=null;this.src='assets/images/webseries/not_found.png';">
			...
			<h3 class="card-title"><a href="webseries/<?php echo $series_detail['slug']; ?>"><?php echo $series_detail['title']; ?></a></h3>
		</div>
	</div>
