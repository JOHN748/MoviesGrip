<div class="latest-webseries mt5">
	...
	<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
		<div class="movie-card mt10">
			<a href="#" class="card-cover">
				<img src="assets/images/movies/m2.jpg" alt="">
