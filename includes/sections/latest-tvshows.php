...
<div class="row row--grid">
    ...
    <?php foreach ($show_details as $show_detail): ?>
		
	<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
		<div class="movie-card mt10">
			<a href="tvshows/<?php echo $show_detail['slug']; ?>" class="card-cover">
				<img src="assets/images/tvshows/<?php echo $show_detail['title']; ?>/<?php echo $show_detail['image'] ?>" alt="Not Found" onerror="this.onerror=null;this.src='assets/images/tvshows/not_found.png';">
