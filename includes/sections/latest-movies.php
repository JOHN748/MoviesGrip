...
<div class="row row--grid">
    ...
    <?php foreach ($movie_details as $movie_detail): ?>
		
	<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
		<div class="movie-card mt10">
			<a href="movies/<?php echo $movie_detail['slug']; ?>" class="card-cover">
				<img src="assets/images/movies/<?php echo $movie_detail['title']; ?>/<?php echo $movie_detail['image'] ?>" alt="Not Found" onerror="this.onerror=null;this.src='assets/images/movies/not_found.png';">
