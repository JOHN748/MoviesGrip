...
<div id="content" class="row row--grid mt-4">
  ...
  <?php
    $lang     = $show_detail['language'];
    $qual     = $show_detail['quality'];
    $rating   = $show_detail['rating'];
    $genre    = $show_detail['genre'];
  ...
  <div class="result col-6 col-sm-4 col-lg-3 col-xl-2 <?php echo $quality." ".$genre." ".$language." ".$rating; ?>">
    <div class="movie-card mt10">
      <a href="tvshows/<?php echo $show_detail['slug'] ?>" class="card-cover">
        <img src="assets/images/tvshows/<?php echo $show_detail['title']; ?>/<?php echo $show_detail['image']; ?>" >
      ...
      <h3 class="card-title"><a href="#"><?php echo $show_detail['title']; ?></a></h3>
    </div>
  </div>
