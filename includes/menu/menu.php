        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="#">Tamil-Series</a></li>
                        <li><a href="#">Telugu-Series</a></li>
                        <li><a href="#">Hindi-Series</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="#">Tamil-Shows</a></li>
                        <li><a href="#">Telugu-Shows</a></li>
                        <li><a href="#">Hindi-Shows</a></li>
                        <li><a href="#">English-Shows</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="#" class=" waves-effect">
                        <i class="fas fa-language" style="font-size: 1.3em;"></i>
                        <span>Languages</span>
                    </a>
                </li>
